...
//@Spring의 Controller와 @RequestMapping을 합친 개념입니다.
@WebServlet("/myDispatcherServlet")  // http://localhost/ch2/myDispatcherServlet?year=2021&month=10&day=1
public class MyDispatcherServlet extends HttpServlet { //서블릿은 HTTP서블릿을 상속 받아야합니다.
	@Override
	public void service(HttpServletRequest request, HttpServletResponse response) throws IOException {
		Map map = request.getParameterMap(); //year,month,day가 Map에 key,value로 담아지게 됩니다.
		Model  model = null;
		String viewName = "";
	...
	private void render(Model model, String viewName, HttpServletResponse response) throws IOException {
		...
		//브라우저에 출력될 수 있도록 response를 적어주었습니다.
